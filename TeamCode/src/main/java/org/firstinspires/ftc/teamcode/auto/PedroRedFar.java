...
public class PedroRedFar extends NextFTCOpMode {
    ...
    private Command autonomousRoutine() {
        Pose startPose = new Pose(84, 8.5, Math.toRadians(90));
        Pose shootPose = new Pose (85, 100, Math.toRadians(40));
...
//                .build();
        ...
        return new SequentialGroup(
                ...
                new FollowPath(shootToRow3Start, true, 0.5),
                Intake.INSTANCE.startIntake.thenWait(1.0),
