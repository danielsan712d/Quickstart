...
@Autonomous(name = "Auto Blue Next to Goal")
public class PedroBlueGoal extends NextFTCOpMode {


    public PedroBlueGoal() {
...
//        Pose startPose = new Pose(117.7, 127.5, Math.toRadians(45));
        Pose startPose = new Pose(33, 135, Math.toRadians(90));
        Pose shootPose = new Pose (48, 108.5, Math.toRadians(45));
        Pose row1Start = new Pose(48, 84, Math.toRadians(0));
        Pose row1End = new Pose(20, 84, Math.toRadians(0));
        Pose parkPose = new Pose(29, 84, Math.toRadians(270));
