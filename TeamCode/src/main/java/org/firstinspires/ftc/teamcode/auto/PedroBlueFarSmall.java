...
@Autonomous(name = "Auto Blue Far Small Triangle")
public class PedroBlueFarSmall extends NextFTCOpMode {


    public PedroBlueFarSmall() {
    ...
    private Command autonomousRoutine() {
        Pose startPose = new Pose(59, 8.5, Math.toRadians(118));
        Pose shootPose = new Pose (59, 8.5, Math.toRadians(40));
        Pose row3Start = new Pose(48, 35, Math.toRadians(180));
        Pose row3End = new Pose(24, 35, Math.toRadians(180));
        Pose movePoints = new Pose(59, 35, Math.toRadians(0));
        ...
        PathChain row3StartToEnd = follower().pathBuilder()
                ...
                .build();
        PathChain shootPoseToMovePoints = follower().pathBuilder()
                .addPath(new BezierLine(startPose, movePoints))
                .setLinearHeadingInterpolation(startPose.getHeading(), movePoints.getHeading())
                .build();
...
//                .build();
        ...
        return new SequentialGroup(
                Launcher.INSTANCE.setLauncherPower(0.7).thenWait(7.0),
         //       new FollowPath(startToShoot, true, 0.6),
                ...
                new FollowPath(shootPoseToMovePoints, true, 0.3).endAfter(1.0)
                //Intake.INSTANCE.startIntake.thenWait(1.0)
